...
const database_rewrite_listener_1 = require("../listeners/database/database-rewrite-listener");
...
class SQLProcessorOrchestrator {
    ...
    setupDefaultListeners() {
        ...
        if (this.config.listeners.databaseRewrite?.enabled) {
            this.listenerChain.addListener(new database_rewrite_listener_1.DatabaseRewriteListener(this.config.listeners.databaseRewrite));
        }
        // 租户过滤 Listener
